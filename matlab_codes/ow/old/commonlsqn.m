function [x,Resnorm,FVAL,EXITFLAG,OUTPUT,LAMBDA,JACOB] = commonlsqn(FUN,x,YDATA,LB,UB,options,defaultopt,caller,computeLambda,varargin)
...
[xstart,l,u,msg] = boundscheck(xstart,LB,UB,numberOfVariables);
if ~isempty(msg)
    EXITFLAG = -1;
