function [x,Resnorm,FVAL,EXITFLAG,OUTPUT,LAMBDA,JACOB] = nonlinlsq(FUN,x,LB,UB,options,varargin)
...
%   $Revision: 1.31 $  $Date: 2002/03/12 20:36:20 $
...
caller = 'nonlinlsq'; YDATA = [];
[x,Resnorm,FVAL,EXITFLAG,OUTPUT,LAMBDA,JACOB] = ...
   commonlsqn(FUN,x,YDATA,LB,UB,options,defaultopt,caller,...
