...
%     'JULD_DEEP_PARK_START_STATUS','JULD_ASCENT_START','JULD_ASCENT_START_STATUS',...
%     'JULD_DEEP_ASCENT_START','JULD_DEEP_ASCENT_START_STATUS','JULD_ASCENT_END',...
