...
% GETCONDENSEDCFHISTORY - Get the condensed change flag history for a given
%   file name and list of variables
%   VERSION HISTORY:
%       May 2017: Current working version
%       21 Feb. 2018, IG: Added a clause to handle undefined OldValues
nq=[];
