% Publish DMQC'd Argo NetCDF files to MEDS' FTP server
%
% Isabelle Gaboury, 01 June 2017, modified from from publishtoweb.m dated 3
% February 2017

function publishtoweb_ig(local_config,lo_system_configuration,floatNum,pub)
close all
...
% The following FTP commands don't currently work. For now, I'm copying
% everything to a directory from which Mathieu can carry out the FTP
% operations
if ~ispc
    % IG: Temporary lines
    ftp_dir = ['/u01/rapps/argo_dm/ready_to_ftp/' floatNum '/'];
